...
import {IUser, User, userValidator} from '../schemas/user.schema';
...
userRouter.post('/create', zodValidator(userValidator), (req: Request, res: Response) => _userController.create(res, req.body))
